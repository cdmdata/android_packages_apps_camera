...
public class CameraSettings {
    ...
    private static final int DEFAULT_VIDEO_DURATION = 2 * 60; // 2 mins
    
    private static final int DIGITALLOT_VIDEO_DURATION = 30;
    ...
    public static int getVidoeDurationInMillis(String quality) {
        ...
        } else if (VIDEO_QUALITY_DIGITALLOT.equals(quality)) {
            return DIGITALLOT_VIDEO_DURATION * 1000;
        }
